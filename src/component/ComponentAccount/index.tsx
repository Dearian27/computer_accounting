...
const ComponentAccount: React.FC<ComponentAccountParams> = ({ id }) => {
  ...
  const component = allComponents.find((component: componentParams) => component._id === currentId);
        ...
        <div style={{display:'flex', justifyContent: 'space-between', alignItems: 'center'}}>
          <div className='component'>
            ...
            <div className='anchor'>{computerName ? 
              <Link className='link' to={`/components/${component?.anchor}`}>{computerName}</Link>
              :
